...
xi.einherjar.settings =
{
    ...
    -- Skip level, ToAU mission, lockout, and feather-tier gates for reservation/entry (see main.lua)
    EINHERJAR_FREE_ENTRY = xi.settings.main.EINHERJAR_FREE_ENTRY or false,
