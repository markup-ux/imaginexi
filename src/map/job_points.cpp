    ...
    switch (jobId)
    {
        case JOB_BLM:
            if (totalJpSpent >= 100 && !charutils::hasSpell(PChar, (uint16)SpellID::Fire_VI))
            {
                for (const SpellID elementalSpell : { SpellID::Fire_VI,
                                                      ...
                                                      SpellID::Water_VI })
                {
                    charutils::addSpell(PChar, (uint16)elementalSpell, true);
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Aspir_III, true);
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Death, true);
        ...
        case JOB_BRD:
            if (totalJpSpent >= 100 && !charutils::hasSpell(PChar, (uint16)SpellID::Fire_Threnody_II))
            {
                ...
                {
                    charutils::addSpell(PChar, (uint16)threnodySpell, true);
        ...
        case JOB_DRK:
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Endark_II, true);
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Drain_III, true);
        ...
        case JOB_GEO:
            if (totalJpSpent >= 100)
            {
                                                      ...
                                                      SpellID::Water_V })
                {
                    ...
                    {
                        charutils::addSpell(PChar, spellIdNum, true);
        ...
        case JOB_NIN:
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Utsusemi_San, true);
        ...
        case JOB_PLD:
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Enlight_II, true);
        ...
        case JOB_RDM:
            ...
            if (totalJpSpent >= 550 && !charutils::hasSpell(PChar, (uint16)SpellID::Addle_II))
            {
                for (const SpellID enfeeblingSpell : { SpellID::Addle_II,
                                                       ...
                                                       SpellID::Frazzle_III })
                {
                    charutils::addSpell(PChar, (uint16)enfeeblingSpell, true);
        ...
        case JOB_RUN:
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Temper, true);
        ...
        case JOB_WHM:
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Reraise_IV, true);
            ...
            {
                charutils::addSpell(PChar, (uint16)SpellID::Full_Cure, true);
