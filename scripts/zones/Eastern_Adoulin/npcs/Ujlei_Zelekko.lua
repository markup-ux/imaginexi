...
local items =
{
    ...
    [ 516] = { cost =   10, id = xi.item.COALITION_POTION },
    [ 772] = { cost =   10, id = xi.item.COALITION_ETHER },
    [1028] = { cost = 1000, id = xi.item.COALITION_POTION },
    [1284] = { cost = 1000, id = xi.item.COALITION_ETHER },
    [1540] = { cost = 1000, id = xi.item.COALITION_POTION },
