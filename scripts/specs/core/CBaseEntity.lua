...
--- Sends client toward PlayOnline / character select (POLEXIT). Experimental.
---@return nil
function CBaseEntity:polExit()
end
...
---@param previewRace integer
---@return table
function CBaseEntity:getAppearancePreviewModelIds(previewRace)
end
...
--- Shorten every active job-ability recast by this many seconds (PC only; skips 1hr/2hr/mount buckets).
---@param seconds integer
---@return nil
function CBaseEntity:reduceAllAbilityRecasts(seconds)
end
...
---@return nil
function CBaseEntity:despawnPet(pet)
end
...
---@nodiscard
---@return integer
function CBaseEntity:getPetCount()
end
