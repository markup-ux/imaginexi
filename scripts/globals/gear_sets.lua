...
local gearSets =
{
    ...
    [45] = -- Brilliant Earring Set. Set Bonus: Evasion, HP Recovered while healing, Conserve MP (ImagineXI: enmity removed)
    {
        items =
        {
    ...
    -- ImagineXI AF1 (AF1_DETAILED_SUGGESTIONS_IMAGINEXI.md): 2pc (flat tiers 2-4) + 5pc
    [134] = { items = { 12511, 12638, 13961, 14214, 14089 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.ACC, 10, 10, 10 } } },
    [135] = { items = { 12511, 12638, 13961, 14214, 14089 }, minEquipped = 5, mods = { { xi.mod.STORETP, 5 } } },

    [136] = { items = { 12512, 12639, 13962, 14215, 14090 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.SUBTLE_BLOW, 3, 3, 3 } } },
    [137] = { items = { 12512, 12639, 13962, 14215, 14090 }, minEquipped = 5, mods = { { xi.mod.GUARD, 5 }, { xi.mod.COUNTER, 1 } } },

    [138] = { items = { 13855, 12640, 13963, 14216, 14091 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.HASTE_GEAR, 200, 200, 200 } } },
    [139] = { items = { 13855, 12640, 13963, 14216, 14091 }, minEquipped = 5, mods = { { xi.mod.FASTCAST, 5 }, { xi.mod.CURE_POTENCY, 3 } } },

    [140] = { items = { 13856, 12641, 13964, 14217, 14092 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.MATT, 2, 2, 2 } } },
    [141] = { items = { 13856, 12641, 13964, 14217, 14092 }, minEquipped = 5, mods = { { xi.mod.ELEM, 7 } } },

    [142] = { items = { 12513, 12642, 13965, 14218, 14093 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.ENFEEBLE, 5, 5, 5 } } },
    [143] = { items = { 12513, 12642, 13965, 14218, 14093 }, minEquipped = 5, mods = { { xi.mod.MACC, 5 }, { xi.mod.HASTE_GEAR, 200 } } },

    [144] = { items = { 12514, 12643, 13966, 14219, 14094 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.DEX, 3, 3, 3 } } },
    [145] = { items = { 12514, 12643, 13966, 14219, 14094 }, minEquipped = 5, mods = { { xi.mod.ACC, 15 } } },

    [146] = { items = { 12515, 12644, 13967, 14220, 14095 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.SHIELD, 5, 5, 5 } } },
    [147] = { items = { 12515, 12644, 13967, 14220, 14095 }, minEquipped = 5, mods = { { xi.mod.VIT, 4 }, { xi.mod.DMGPHYS, -200 } } },

    [148] = { items = { 12516, 12645, 13968, 14221, 14096 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.ATT, 5, 5, 5 } } },
    [149] = { items = { 12516, 12645, 13968, 14221, 14096 }, minEquipped = 5, mods = { { xi.mod.DARK, 5 }, { xi.mod.HASTE_GEAR, 200 } } },

    [150] = { items = { 12517, 12646, 13969, 14222, 14097 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.REWARD_HP_BONUS, 5, 5, 5 } } },
    [151] = { items = { 12517, 12646, 13969, 14222, 14097 }, minEquipped = 5, mods = { { xi.mod.PET_ACC_EVA, 10 } } },

    [152] = { items = { 13857, 12647, 13970, 14223, 14098 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.SINGING, 3, 3, 3 } } },
    [153] = { items = { 13857, 12647, 13970, 14223, 14098 }, minEquipped = 5, mods = { { xi.mod.SONG_SPELLCASTING_TIME, 5 }, { xi.mod.CHR, 3 } } },

    [154] = { items = { 12518, 12648, 13971, 14224, 14099 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.RACC, 10, 10, 10 } } },
    [155] = { items = { 12518, 12648, 13971, 14224, 14099 }, minEquipped = 5, mods = { { xi.mod.RATT, 5 }, { xi.mod.SNAPSHOT, 3 } } },

    [156] = { items = { 13868, 13781, 13972, 14225, 14100 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.STORETP, 3, 3, 3 } } },
    [157] = { items = { 13868, 13781, 13972, 14225, 14100 }, minEquipped = 5, mods = { { xi.mod.ZANSHIN, 5 } } },

    [158] = { items = { 13869, 13782, 13973, 14226, 14101 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.NINJUTSU, 5, 5, 5 } } },
    [159] = { items = { 13869, 13782, 13973, 14226, 14101 }, minEquipped = 5, mods = { { xi.mod.EVA, 10 } } },

    [160] = { items = { 12519, 12649, 13974, 14227, 14102 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.JUMP_ATT_BONUS, 5, 5, 5 } } },
    [161] = { items = { 12519, 12649, 13974, 14227, 14102 }, minEquipped = 5, mods = { { xi.mod.STR, 3 }, { xi.mod.PET_ACC_EVA, 5 } } },

    [162] = { items = { 12520, 12650, 13975, 14228, 14103 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.SUMMONING, 7, 7, 7 } } },
    [163] = { items = { 12520, 12650, 13975, 14228, 14103 }, minEquipped = 5, mods = { { xi.mod.PET_MAB_MDB, 8 } } },

    [164] = { items = { 15265, 14521, 14928, 15600, 15684 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.BLUE, 5, 5, 5 } } },
    [165] = { items = { 15265, 14521, 14928, 15600, 15684 }, minEquipped = 5, mods = { { xi.mod.ATTP, 2 } } },

    [166] = { items = { 15266, 14522, 14929, 15601, 15685 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.QUICK_DRAW_DMG, 3, 3, 3 } } },
    [167] = { items = { 15266, 14522, 14929, 15601, 15685 }, minEquipped = 5, mods = { { xi.mod.RACC, 10 } } },

    [168] = { items = { 15267, 14523, 14930, 15602, 15686 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.AUTO_MELEE_SKILL, 5, 5, 5 } } },
    [169] = { items = { 15267, 14523, 14930, 15602, 15686 }, minEquipped = 5, mods = { { xi.mod.REPAIR_POTENCY, 10 }, { xi.mod.OVERLOAD_THRESH, 5 } } },

    [170] = { items = { 16138, 16139, 14578, 14579, 15002, 15003, 15659, 15660, 15746, 15747 }, minEquipped = 2, maxEquipped = 4, mods = { { xi.mod.ACC, 10, 10, 10 } } },
    [171] = { items = { 16138, 16139, 14578, 14579, 15002, 15003, 15659, 15660, 15746, 15747 }, minEquipped = 5, mods = { { xi.mod.HASTE_GEAR, 300 }, { xi.mod.WALTZ_POTENCY, 5 } } },

    [173] = -- NIN AF: Anju + Zushio pair bonus
    {
        items =
        {
            xi.item.ANJU,
