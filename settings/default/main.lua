...
xi.settings.main =
{
    ...
    EINHERJAR_ENABLED    = false,
    EINHERJAR_FREE_ENTRY = false,
    ...
    MAX_LEVEL                      = 75, -- Imagine XI permanent level cap; disables Limit Break quests above this level.
