...
public:
    ...
    auto   getAppearancePreviewModelIds(uint8 previewRace) -> sol::table;
    uint16 getCostume();
    ...
    void reduceAllAbilityRecasts(uint32 seconds);   // Shorten all ability timers (PC); skips 1hr/2hr/mount buckets
    ...
    void despawnPet(sol::optional<CLuaBaseEntity*> maybePet);
    void despawnCharmedPet();
