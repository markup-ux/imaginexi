...
entity.onMobSpawn = function(mob)
    ...
    -- Optional family-native apex mode for Adamantoise only.
    if xi.settings.map.ADAMANTOISE_FAMILY_NATIVE_APEX_MODE then
        ...
        if xi.settings.map.ADAMANTOISE_SAFE_CROSS_FAMILY_APEX_MODE then
