...
local packets =
{
    ...
    ['Shell III Self (Hit)'] =
    {
        test = function(player, mob)
            player:changeJob(xi.job.WHM)
            player:setLevel(75)
            player:addSpell(xi.magic.spell.SHELL_III)
            player.actions:useSpell(player, xi.magic.spell.SHELL_III)
        ...
        expected =
        {
            ...
            res_sum = 0,
            cmd_no  = xi.action.category.MAGIC_FINISH,
            cmd_arg = xi.magic.spell.SHELL_III,
            info    = ph.IGNORE,
            target  =
            {
                {
                    ...
                    {
                        {
                            miss      = xi.action.resolution.HIT,
                            kind      = 0,
                            sub_kind  = xi.magic.spell.SHELL_III,
                            info      = 0,
                            scale     = 0,
                            value     = xi.effect.SHELL,
                            message   = xi.msg.basic.MAGIC_GAIN_EFFECT,
                            bit       = 0,
                            has_proc  = false,
                            has_react = false,
    ...
    {
        test = function(player, mob)
            player:changeJob(xi.job.PLD)
            player:setLevel(75)
            player:addSpell(xi.magic.spell.REPRISAL)
            player.actions:useSpell(player, xi.magic.spell.REPRISAL)
            xi.test.world:skipTime(10)
        end,
        ...
        expected =
        {
            ...
            res_sum = 0,
            cmd_no  = xi.action.category.MAGIC_FINISH,
            cmd_arg = xi.magic.spell.REPRISAL,
            info    = ph.IGNORE,
            target  =
            {
                {
                    ...
                    {
                        {
                            miss      = xi.action.resolution.HIT,
                            kind      = 0,
                            sub_kind  = xi.magic.spell.REPRISAL,
                            info      = 0,
                            scale     = 0,
                            value     = xi.effect.REPRISAL,
                            message   = xi.msg.basic.MAGIC_GAIN_EFFECT,
                            bit       = 0,
                            has_proc  = false,
                            has_react = false,
